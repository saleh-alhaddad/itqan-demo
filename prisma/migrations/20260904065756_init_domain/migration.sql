-- citext makes email uniqueness case-insensitive in the database, so no query has to
-- remember to lowercase. Created here because declaring it in schema.prisma would
-- require the postgresqlExtensions preview feature.
